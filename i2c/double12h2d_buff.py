...
f2 = open('/root/i2c/temp1002.log', 'r')
for line in f2:
   #Mon Feb  4 11:29:55 2013 --> 16.5
   linespit = line.split(' --> ')
   ParsedTime = time.mktime(time.strptime(linespit[0], "%a %b %d %H-%M-%S %Y"))
   n+=1
   x2.append(ParsedTime+7200) #summer
   #x2.append(ParsedTime+3600) #winter
